				...
				<div class="panel-body">
					<h4>Datos Principales</h4><br>
						<div class="container" id="fila1">
						    ...
						    <div class="btn-group col-md-3">
								Primer nombre:<input name="fechanac"class="form-control"  type="text" autofocus="" required=""  placeholder=""><br>
						    </div>
						</div>
					<br><div class="container">
						    ...
						    <div class="btn-group col-md-3">
								Dirección (calle,avenida,zona):<input name="fechanac"class="form-control"  type="text" autofocus="" required=""  placeholder=""><br>
						    </div>
						</div>
						<br><div class="container">
							<div class="btn-group col-md-3">
						    ...
						    <div class="btn-group col-md-3">
								Fecha Nacimiento:<input name="fechanac"class="form-control"  type="date" autofocus="" required=""  placeholder=""><br>
						    </div>
						</div>
